...
public class VpAuthenticationNonceFilter extends OncePerRequestFilter {
    private static final String DEFAULT_LOGIN_INIT_URL = "/login/vp/nonce";
    ...
    public VpAuthenticationNonceFilter(ChallengeNonceStore challengeNonceStore, Duration challengeNonceTtlMinutes) {
        nonceGenerator = new ChallengeNonceGeneratorBuilder()
                .withNonceTtl(challengeNonceTtlMinutes)
