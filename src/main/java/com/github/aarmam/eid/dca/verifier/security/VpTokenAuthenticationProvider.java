...
public class VpTokenAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        try {
            final ChallengeNonce nonce = challengeNonceStore.getAndRemove();
            final VpUserEntity eidUser = vpTokenValidator.validate(authentication.getCredentials(), nonce.getBase64EncodedNonce());
