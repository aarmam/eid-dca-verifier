...
import com.github.aarmam.eid.dca.verifier.security.VpAuthenticationNonceFilter;
...
public class SecurityConfiguration {
    ...
    private Duration challengeNonceTtlMinutes;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, ChallengeNonceStore challengeNonceStore, VpTokenValidator vpTokenValidator) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .anyRequest()
                        .authenticated())
                .addFilterBefore(new VpAuthenticationNonceFilter(challengeNonceStore, challengeNonceTtlMinutes), AuthorizationFilter.class)
    ...
    public List<X509Certificate> trustedRootCAs(SslBundles sslBundles) throws KeyStoreException {
        ...
        while (aliases.hasMoreElements()) {
            ...
            if (certificate != null) {
                issuerTrustedRootCAs.add(certificate);
            }
        }
